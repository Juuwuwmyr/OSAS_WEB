    ...
    if (!settingsPanel) {
            ...
            <div class="settings-section">
              ...
              <div class="setting-item">
                ...
                <div class="setting-control">
                  <input type="text" class="setting-input" id="userDisplayName" placeholder="${document.querySelector('.user-name')?.textContent || 'Admin'}">
                </div>
              </div>
        ...
        if (!document.getElementById('settingsPanelStyles')) {
            ...
            styles.textContent = `
                ...
                body.dark .settings-panel-close {
                  color: #a0aec0 !important;
                }

                body.dark .settings-panel-close:hover {
                  background: #4a5568 !important;
                  color: #f7fafc !important;
                }

                body.dark .settings-section-title i {
                  color: #ffd700 !important;
                }

                body.dark .settings-panel-title i {
                  color: #ffd700 !important;
                }
...
function loadDefaultSettings() {
    ...
    document.getElementById('userTheme').value = document.body.classList.contains('dark') ? 'dark' : 'light';
    ...
    if (userAvatar && userDropdown) {
        ...
        dropdownItems.forEach(item => {
            item.addEventListener('click', function(e) {
                ...
                if (item.classList.contains('settings-item')) {
