...
<main id="Students-page">
  ...
  <div id="importModal" class="modal">
    ...
    <div class="modal-container import-modal-container">
      ...
      <div class="modal-body">
        <p class="export-description">Upload a file to import students. Supported formats: CSV, Excel (.xlsx)</p>
        ...
        <div class="import-info-box">
          ...
          <ul>
            <li>Required columns: <strong>Student ID</strong>, <strong>First Name</strong>, <strong>Last Name</strong>, <strong>Department</strong></li>
            <li>Optional columns: <strong>Middle Name</strong>, <strong>Section</strong>, <strong>Email</strong>, <strong>Phone</strong>, <strong>Status</strong></li>
            <li>First row should contain column headers</li>
            <li>Status values: <strong>active</strong>, <strong>inactive</strong>, or <strong>graduating</strong> (default: active)</li>
          </ul>
        </div>
